...
export class Migration1689623943161 implements MigrationInterface {
    name = 'Migration1689623943161'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction" ADD CONSTRAINT "FK_230a4a5d7a463f9d54fb701e93e" FOREIGN KEY ("userISendId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "transaction" DROP CONSTRAINT "FK_230a4a5d7a463f9d54fb701e93e"`);
