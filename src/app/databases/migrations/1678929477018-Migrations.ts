...
export class Migrations1678929477018 implements MigrationInterface {
    name = 'Migrations1678929477018'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contributor" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "contributeType" character varying, "contributeId" uuid, "userId" uuid, "organizationId" uuid, "userCreatedId" uuid, "role" "public"."contributor_role_enum" NOT NULL DEFAULT 'ADMIN', CONSTRAINT "PK_816afef005b8100becacdeb6e58" PRIMARY KEY ("id"))`);
