...
export class Migration1691524089077 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "membership" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying, "image" character varying, "isActive" boolean NOT NULL DEFAULT true, "description" text, "messageWelcome" text, "pricePerMonthly" double precision NOT NULL, "pricePerYearly" double precision NOT NULL, "currencyId" uuid, "userId" uuid, CONSTRAINT "PK_83c1afebef3059472e7c37e8de8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."gallery_whocansee_enum" AS ENUM('PUBLIC', 'MEMBERSHIP', 'SUPPORTER')`);
        await queryRunner.query(`CREATE TABLE "gallery" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "url" character varying, "whoCanSee" "public"."gallery_whocansee_enum" NOT NULL DEFAULT 'PUBLIC', "allowDownload" boolean NOT NULL DEFAULT true, "title" character varying, "description" text, "userId" uuid, CONSTRAINT "PK_65d7a1ef91ddafb3e7071b188a0" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "gallery" ADD CONSTRAINT "FK_532a9bd29d33ca8b135fe5b2820" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."gallery_whocansee_enum"`);
