...
export class Migration1699695144841 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "client_order" DROP COLUMN "userClientId"`);
        ...
        await queryRunner.query(`ALTER TABLE "client_order" ADD "organizationId" uuid`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "client_order" DROP COLUMN "organizationId"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP COLUMN "userId"`);
        await queryRunner.query(`ALTER TABLE "client_order" DROP COLUMN "productId"`);
        await queryRunner.query(`ALTER TABLE "client_order" ADD "userClientId" uuid`);
    }
