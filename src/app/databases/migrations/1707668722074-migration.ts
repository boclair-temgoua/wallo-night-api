...
export class Migration1707668722074 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "cart_order" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" uuid, "model" "public"."cart_order_model_enum" NOT NULL DEFAULT 'PRODUCT', "organizationId" uuid, CONSTRAINT "PK_02e2f497e8ed712f493dc8262f8" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "cart" ADD CONSTRAINT "FK_ed65b2f923d5ea760c3e9b1739b" FOREIGN KEY ("commissionId") REFERENCES "commission"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "FK_5d2bf74baf27e1386676d1ff594" FOREIGN KEY ("commissionId") REFERENCES "commission"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "order_item" ADD CONSTRAINT "FK_845716d96530a440c6cdc6c7346" FOREIGN KEY ("userId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "order_item" DROP CONSTRAINT "FK_5d2bf74baf27e1386676d1ff594"`);
        ...
        await queryRunner.query(`ALTER TABLE "cart" DROP CONSTRAINT "FK_ed65b2f923d5ea760c3e9b1739b"`);
