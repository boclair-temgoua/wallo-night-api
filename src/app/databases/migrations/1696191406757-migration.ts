...
export class Migration1696191406757 implements MigrationInterface {
    name = 'Migration1696191406757'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "post" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "slug" character varying, "title" character varying, "enableUrlMedia" boolean NOT NULL DEFAULT false, "urlMedia" character varying, "whoCanSee" character varying NOT NULL DEFAULT 'PUBLIC', "type" character varying NOT NULL DEFAULT 'ARTICLE', "status" character varying NOT NULL DEFAULT 'ACTIVE', "allowDownload" boolean NOT NULL DEFAULT false, "description" text, "userId" uuid, CONSTRAINT "PK_be5fda3aac270b134ff9c21cdee" PRIMARY KEY ("id"))`);
