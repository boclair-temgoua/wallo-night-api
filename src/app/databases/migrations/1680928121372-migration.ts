...
export class Migration1680928121372 implements MigrationInterface {
    name = 'Migration1680928121372'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TYPE "public"."contact_type_enum" RENAME TO "contact_type_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."contact_type_enum" AS ENUM('ORGANIZATION', 'PROJECT', 'SUBPROJECT', 'SUBSUBPROJECT')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."contributor_type_enum" AS ENUM('ORGANIZATION', 'PROJECT', 'SUBPROJECT', 'SUBSUBPROJECT')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."document_type_enum" AS ENUM('ORGANIZATION', 'PROJECT', 'SUBPROJECT', 'SUBSUBPROJECT')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."document_type_enum_old" AS ENUM('ORGANIZATION', 'PROJECT', 'SUBPROJECT')`);
        await queryRunner.query(`ALTER TABLE "document" ALTER COLUMN "type" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."contributor_type_enum_old" AS ENUM('ORGANIZATION', 'PROJECT', 'SUBPROJECT')`);
        await queryRunner.query(`ALTER TABLE "contributor" ALTER COLUMN "type" DROP DEFAULT`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."contact_type_enum_old" AS ENUM('ORGANIZATION', 'PROJECT', 'SUBPROJECT')`);
        await queryRunner.query(`ALTER TABLE "contact" ALTER COLUMN "type" DROP DEFAULT`);
