...
export class Migration1707744836593 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" ADD CONSTRAINT "UQ_a6e45c89cfbe8d92840266fd30f" UNIQUE ("orderId")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "transaction" DROP CONSTRAINT "UQ_a6e45c89cfbe8d92840266fd30f"`,
    );
