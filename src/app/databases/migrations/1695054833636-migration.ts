...
export class Migration1695054833636 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "user" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "confirmedAt" TIMESTAMP, "email" character varying, "accessToken" text, "refreshToken" text, "username" character varying, "token" character varying, "password" character varying, "nextStep" character varying NOT NULL DEFAULT 'SETTING_PROFILE', "profileId" uuid, CONSTRAINT "UQ_e12875dfb3b1d92d7d7c5377e22" UNIQUE ("email"), CONSTRAINT "UQ_78a916df40e02a9deb1c4b75edb" UNIQUE ("username"), CONSTRAINT "REL_9466682df91534dd95e4dbaa61" UNIQUE ("profileId"), CONSTRAINT "PK_cace4a159ff9f2512dd42373760" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "discount" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "code" character varying, "description" character varying, "percent" bigint NOT NULL DEFAULT '0', "expiredAt" TIMESTAMP WITH TIME ZONE, "enableExpiredAt" boolean NOT NULL DEFAULT false, "startedAt" TIMESTAMP WITH TIME ZONE, "userId" uuid, CONSTRAINT "PK_d05d8712e429673e459e7f1cddb" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "upload" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "name" character varying, "path" character varying, "status" character varying, "url" character varying, "uploadType" character varying NOT NULL DEFAULT 'IMAGE', "userId" uuid, "model" character varying NOT NULL DEFAULT 'PRODUCT', "uploadableId" uuid, CONSTRAINT "PK_1fe8db121b3de4ddfa677fc51f3" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "commission" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying, "image" character varying, "urlMedia" character varying, "price" bigint NOT NULL DEFAULT '0', "description" text, "enableLimitSlot" boolean NOT NULL DEFAULT false, "limitSlot" bigint NOT NULL DEFAULT '0', "messageAfterPayment" text, "status" character varying NOT NULL DEFAULT 'ACTIVE', "currencyId" uuid, "userId" uuid, CONSTRAINT "PK_d108d70411783e2a3a84e386601" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "product" ("createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "id" uuid NOT NULL DEFAULT uuid_generate_v4(), "title" character varying, "subTitle" character varying, "slug" character varying, "sku" character varying, "urlMedia" character varying, "price" bigint NOT NULL DEFAULT '0', "description" text, "messageAfterPayment" text, "moreDescription" character varying, "enableChooseQuantity" boolean NOT NULL DEFAULT false, "enableDiscount" boolean NOT NULL DEFAULT false, "enableLimitSlot" boolean NOT NULL DEFAULT false, "limitSlot" bigint NOT NULL DEFAULT '0', "status" character varying NOT NULL DEFAULT 'ACTIVE', "categoryId" uuid, "discountId" uuid, "currencyId" uuid, "userId" uuid, CONSTRAINT "UQ_8cfaf4a1e80806d58e3dbe69224" UNIQUE ("slug"), CONSTRAINT "PK_bebc9158e480b949565b4dc7a82" PRIMARY KEY ("id"))`);
